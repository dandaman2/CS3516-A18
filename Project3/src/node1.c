...
void rtupdate1(struct RoutePacket *rcvdpkt) {
	if(TraceLevel >=1) printf("rtupdate1\n");

	int updated;
	//Updates the table with new min costs
	updated = should_update(&dt1, rcvdpkt, neighbor1->NodesInNetwork, NODE_ID);
	if(updated){
