...
void rtupdate3( struct RoutePacket *rcvdpkt ) {
	if(TraceLevel >=1) printf("rtupdate3\n");

	int updated;
	//Updates the table with new min costs
	updated = should_update(&dt3, rcvdpkt, neighbor3->NodesInNetwork, NODE_ID);
	if(updated){
